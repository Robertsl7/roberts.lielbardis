...
if pasažieri >4 : #pasažieru skaits tiek ierobežots līdz 4
    ...
    if pulkstenis >5 or pulkstenis<23:
       print('Par taksi šajā laika periodā būs jāmaksā 0,47 par km ')
    elif pulkstenis <6 or pulkstenis>23:
        print('Par taksi šajā laika periodā būs jāmaksā 0,87 par km ')
    ...
    if vieta == 'nē':
        ...
        gaidīšana = (input ('Vai Jums ir vēlme veikt apstāšanos pa ceļam? (jā/nē)  '))#tiek veikta apstāšanās jautājuma uzdošana
        if gaidīšana == 'jā':
            print('Cik ilgi? (Par katru gaidīšanas mīnūti jāpiemaksā 0,15) ')
        elif gaidīšana =='nē':
